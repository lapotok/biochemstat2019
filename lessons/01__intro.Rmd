...
* Почему R?
  * одна из самых используемых программ
  * бесплатно
  * reproducibility
  * R vs Excel: программирование и окошки -> окошек не достаточно
  * все статистические пакеты (SPSS, SAS, Stata, Statistica, Origin, GraphPad) имеют скриптовый язык ... и только у Python и R он не убогий
  * самое сложное - подготовка данных, проверка наличия ошибок
...
* нормальное распределение, симуляция распределения
